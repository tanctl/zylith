...
#[derive(Debug, Clone, Default)]
pub struct MembershipWitnessInputs {
    pub values: HashMap<String, WitnessValue>,
}
...
/// builds a witness json from caller-supplied fields matching the membership circuit inputs.
pub fn generate_membership_witness_inputs(
    inputs: MembershipWitnessInputs,
