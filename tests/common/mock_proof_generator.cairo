...
use zylith::privacy::ZylithVerifier::{
    DepositPublicOutputs, WithdrawPublicOutputs, MembershipPublicOutputs, IZylithVerifier,
};
use crate::common::{
...
pub mod MockZylithVerifier {
    use super::{
        ArrayTrait, ContractAddress, DepositPublicOutputs, MembershipPublicOutputs, Option,
    ...
    impl MockZylithVerifierImpl of IZylithVerifier<ContractState> {
        ...
        fn verify_membership_proof(
            ...
            let _ = calldata;
            Option::<MembershipPublicOutputs>::None
        }
